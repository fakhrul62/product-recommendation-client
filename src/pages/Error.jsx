...
const Error = () => {
    return (
        <main className="h-screen w-full flex flex-col justify-center items-center bg-blue-900">
            <Helmet>
                <meta charSet="utf-8" />
        ...
        <button className="mt-5">
          ...
          >
            ...
            <span className="relative block px-8 py-3 bg-blue-900 border border-current">
              Go Home
            </span>
          </Link>
        </button>
