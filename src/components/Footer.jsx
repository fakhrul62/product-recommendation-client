...
const Footer = () => {
  return (
    <div className="bg-base-200">
      <footer className="footer w-10/12 mx-auto  text-base-content p-10 *:font-body">
        <nav>
      ...
      <footer className="footer w-10/12 mx-auto text-base-content border-base-300 border-t px-10 py-4">
      <aside>
